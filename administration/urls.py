...
urlpatterns = [
    ...
    path('listingapprove/<uuid:listingpk>/',views.listingapprove),
    path('listingreject/,<uuid:listingpk>/',views.listingreject),
    ...
    path('responded/<uuid:querypk>/',views.queryresponded),
    path('deletequery/<uuid:querypk>/',views.querydelete),
    path('localityget/',views.fetchlocalities),
    path('usermanage/',views.usermanageview),
    path('usersearch/',views.usersearch),
    path('userdisable/<uuid:userpk>/',views.userdisable),
    path('userdelete/<uuid:userpk>/',views.userdelete),
    path('userenable/<uuid:userpk>/',views.userenable),
    ...
    path('searchmanage/profile/<uuid:profilepk>/',views.searchprofile),
    path('searchmanage/disable/<uuid:profilepk>/',views.shopdisable),
    path('searchmanage/enable/<uuid:profilepk>/',views.shopenable),
    path('searchmanage/delete/<uuid:profilepk>/',views.shopdelete),
]
